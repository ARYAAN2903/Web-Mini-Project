            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link className="dropdown-item" to="/customer-basketball">
                      Basketball Court
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="/customer-football">
                      Football Ground
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="/customer-top">
                      Top Court
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link className="dropdown-item" to="/customer-seminar">
                      Seminar Hall
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="/customer-mondini">
                      Mondini Hall
                    </Link>
                  </li>
                </ul>
